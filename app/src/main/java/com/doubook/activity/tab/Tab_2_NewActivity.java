...
import com.doubook.fragment.Tab1_NewFragment;
...
public class Tab_2_NewActivity extends BaseActivty {
    ...
    private void initColumnData() {
        ...
        menu3.setTitle("新书榜(非虚构)");
        menu3.setTypeD(0);
        menu3.setTypeX(1);
        PageMenuBean menu4 = new PageMenuBean();
        menu4.setTitle("新书榜(虚构)");
        menu4.setTypeD(0);
        menu4.setTypeX(0);

        pageMenuBeen.add(menu3);
        pageMenuBeen.add(menu4);
    ...
    private void initFragment() {
        ...
        for (int i = 0; i < pageMenuBeen.size(); i++) {
            ...
            Tab1_NewFragment newfragment = new Tab1_NewFragment();
